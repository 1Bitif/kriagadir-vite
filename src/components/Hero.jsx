...
//   return (
//     <section className="relative min-h-[92vh] flex flex-col justify-between bg-cover bg-center bg-no-repeat overflow-hidden transition-all duration-500 ease-in-out"
//       style={{ 
//         backgroundImage: imageLoaded ? "url('/hero-bg.jpg')" : 'none',
...
//       <div className="relative z-10 flex flex-col justify-between h-full min-h-[92vh] px-4 sm:px-8 md:px-16 lg:px-24 pt-28 pb-16">
